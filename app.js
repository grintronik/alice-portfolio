const digitalTitles = [
  ...
  'Абстракция',
  'Принцесса Алтея в рыцарских доспехах',
  'Белла',
  'Флоренс и Анж',
  'Том ночью',
  'Тик-так (Эрик)',
  'Шарлотта',
  'Фиалка',
  'Нарцисс и Шарлотта, сцена',
  'Том в костюме цветочка',
  'Эрик-машинист',
  'Шарлотта в тюрьме',
  'Шарлотта на сцене',
  'Тик-так (Эрик)',
  'Мой аватар, обычный/жуткий',
  'КубаПес в утешительной комнате',
  'Анж',
  'Мой аватар',
  'КривоКот на шоу Кубопса',
